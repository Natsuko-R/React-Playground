...
// 操作用の名前
const MODEL_NAME = 'circurator';


export class CircuratorManager extends ObjectManager{
    ...
    // ファンを配置
    createCircurator(scene, pos, objId){
        ...
        loader.load( PATH_MODEL, (gltf) => {
            ...
            console.log("CircuratorManager: succeeded on loading " + PATH_MODEL);
            ...
            console.log("CircuratorManager: this CircuratorManager has following number of children " + this.children.length);
            ...
            if(this.animations){
                ...
                console.log("CircuratorManager: loaded AnimationFrame from " + PATH_MODEL);
            }

        }, undefined, () => {
        
            // モデル読み込み失敗時
            console.error('CircuratorManager: failed on loading ' + PATH_MODEL);
        
        });
    }

    // アニメーションミキサーの実行
    updateCircuratorGroup(){
    ...
    toggleCircuratorAnimation(objId){
