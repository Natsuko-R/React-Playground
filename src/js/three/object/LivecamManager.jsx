...
// モデルのパス
const PATH_MODEL = '/model/gltf/camera.glb';

// モデルのスケール
const MODEL_SCALE = 50.0;

// 操作用の名前
const MODEL_NAME = 'livecam';


export class LivecamManager extends ObjectManager{

    // ライブカムを配置
    createLivecam(scene, pos, objId){
        ...
        loader.load( PATH_MODEL, (gltf) => {
            ...
            console.log("LivecamManager: succeeded on loading " + PATH_MODEL);
    ...
    ////////////////////////////////////
            ...
            console.log("LivecamManager: this Livecam has following number of children " + this.children.length);

        }, undefined, () => {
        
            // モデル読み込み失敗時
            console.error('LivecamManager: failed on loading ' + PATH_MODEL);
