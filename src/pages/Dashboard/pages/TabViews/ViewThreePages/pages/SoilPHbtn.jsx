...
export default function SoilPHbtn(props) {
  const clickSoilPH = props.clickSoilPH;
  const [clicked, setClicked] = useState(false);
  const handleclick = ()=>{
    setClicked(!clicked);
    props.setclickSoilPH( clickSoilPH => !clickSoilPH );
  }
  ...
  return (
    <div>
        <button className={buttonClass} onClick={handleclick}>
          ...
          <span className='col-start-1 col-span-2 w-12 p-1 ml-2 mb-2 text-xs text-center font-bold text-white rounded-md bg-cyan-800'>pH</span>
