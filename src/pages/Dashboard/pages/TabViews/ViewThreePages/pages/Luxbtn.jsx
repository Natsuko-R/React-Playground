...
export default function Luxbtn(props) {
  const clickLux = props.clickLux;
  const [clicked, setClicked] = useState(false);
  const handleclick = ()=>{
    setClicked(!clicked);
    props.setclickLux( clickLux => !clickLux );
  }
  ...
  return (
    <div>
        <button className={buttonClass} onClick={handleclick}>
          ...
          <span className='col-start-1 col-span-2 w-12 p-1 ml-2 mb-2 text-xs text-center font-bold text-white rounded-md bg-orange-600'>照度</span>
